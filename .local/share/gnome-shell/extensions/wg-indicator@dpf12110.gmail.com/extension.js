...
const WgIndicator = new GObject.registerClass(
    class WgIndicator extends PanelMenu.Button {
        ...
        _refresh() {
            ...
            this._timeout = Mainloop.timeout_add_seconds(this.timeout_seconds, this._refresh.bind(this));
        }
    }
);
